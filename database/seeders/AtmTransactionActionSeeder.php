...
class AtmTransactionActionSeeder extends Seeder
{
    public function run()
    {
        ...
        [
            ...
            ['id' => 10, 'name' => 'Borrowed - Returning', 'type' => 'Going to Head Office','status' => 'Active', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ...
            ['id' => 13, 'name' => 'Cancelled Loan', 'type' => 'Going to Head Office','status' => 'Active', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
