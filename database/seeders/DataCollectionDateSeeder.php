...
class DataCollectionDateSeeder extends Seeder
{
    public function run()
    {
        ...
        [
            ...
            ['collection_date' => '8th / 16th', 'status' => 'Active', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['collection_date' => '8th / 1st', 'status' => 'Active', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
