...
class AtmTransactionActionSeeder extends Seeder
{
    public function run()
    {
        ...
        [
            ...
            [33, 'For ATM Balance',                  5, 'Outside For Collection', 'ATM' , 'Active'],
            [34, 'For Priority Collection',          5, 'Outside For Collection', 'ATM' , 'Active'],
        ];

        foreach ($datas as $data) {
            DB::table('elm_transaction_actions')->insert([
                'id' => $data[0],
                'name' => $data[1],
                'transaction' => $data[2],
