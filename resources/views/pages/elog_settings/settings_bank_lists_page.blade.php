        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('settings.bank.create') }}" id="createValidateForm">
                        @csrf
    ...
    <div class="modal fade" id="updateBankModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('settings.bank.update')  }}" id="updateValidateForm">
                        @csrf
