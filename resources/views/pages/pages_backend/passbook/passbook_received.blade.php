...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title') Passbook Receiving @endslot
    @endcomponent
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 text-start">
                            <h4 class="card-title">Passbook For Collection For Receiving</h4>
                            <p class="card-title-desc ms-2">
                                Where Head Office and Branches can view their Transactions For Receiving.
                            </p>
                        </div>
